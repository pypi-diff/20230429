# Comparing `tmp/dev-dependencies-0.0.1.tar.gz` & `tmp/dev-dependencies-0.1.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dev-dependencies-0.0.1.tar", last modified: Sat Apr 29 21:07:17 2023, max compression
+gzip compressed data, was "dev-dependencies-0.1.1.tar", last modified: Thu Apr 27 15:06:26 2023, max compression
```

## Comparing `dev-dependencies-0.0.1.tar` & `dev-dependencies-0.1.1.tar`

### file list

```diff
@@ -1,27 +1,26 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-29 21:07:17.331556 dev-dependencies-0.0.1/
--rw-r--r--   0 runner    (1001) docker     (123)       14 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/.envrc
--rw-r--r--   0 runner    (1001) docker     (123)      255 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/.flake8
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-29 21:07:17.331556 dev-dependencies-0.0.1/.github/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-29 21:07:17.331556 dev-dependencies-0.0.1/.github/workflows/
--rw-r--r--   0 runner    (1001) docker     (123)     1206 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/.github/workflows/ci.yml
--rw-r--r--   0 runner    (1001) docker     (123)     1681 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/.github/workflows/release.yml
--rw-r--r--   0 runner    (1001) docker     (123)      205 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/.gitignore
--rw-r--r--   0 runner    (1001) docker     (123)        7 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/.python-version
--rw-r--r--   0 runner    (1001) docker     (123)     1069 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)     1108 2023-04-29 21:07:17.331556 dev-dependencies-0.0.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      281 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/Pipfile
--rw-r--r--   0 runner    (1001) docker     (123)    39807 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/Pipfile.lock
--rw-r--r--   0 runner    (1001) docker     (123)      839 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-29 21:07:17.331556 dev-dependencies-0.0.1/dev_dependencies.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     1108 2023-04-29 21:07:17.000000 dev-dependencies-0.0.1/dev_dependencies.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      411 2023-04-29 21:07:17.000000 dev-dependencies-0.0.1/dev_dependencies.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-04-29 21:07:17.000000 dev-dependencies-0.0.1/dev_dependencies.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)      131 2023-04-29 21:07:17.000000 dev-dependencies-0.0.1/dev_dependencies.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        8 2023-04-29 21:07:17.000000 dev-dependencies-0.0.1/dev_dependencies.egg-info/top_level.txt
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-29 21:07:17.331556 dev-dependencies-0.0.1/devdeps/
--rw-r--r--   0 runner    (1001) docker     (123)      225 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/devdeps/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      160 2023-04-29 21:07:17.000000 dev-dependencies-0.0.1/devdeps/_version.py
--rw-r--r--   0 runner    (1001) docker     (123)     1519 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-04-29 21:07:17.331556 dev-dependencies-0.0.1/setup.cfg
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-29 21:07:17.331556 dev-dependencies-0.0.1/tests/
--rw-r--r--   0 runner    (1001) docker     (123)      273 2023-04-29 21:06:34.000000 dev-dependencies-0.0.1/tests/test_version.py
...
### Comparing `dev-dependencies-0.0.1/.github/workflows/ci.yml` & `dev-dependencies-0.1.1/.github/workflows/ci.yml`
...
### Comparing `dev-dependencies-0.0.1/LICENSE` & `dev-dependencies-0.1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `dev-dependencies-0.0.1/PKG-INFO` & `dev-dependencies-0.1.1/PKG-INFO`
...
### Comparing `dev-dependencies-0.0.1/Pipfile.lock` & `dev-dependencies-0.1.1/Pipfile.lock`
...
### Comparing `dev-dependencies-0.0.1/README.md` & `dev-dependencies-0.1.1/README.md`
...
### Comparing `dev-dependencies-0.0.1/dev_dependencies.egg-info/PKG-INFO` & `dev-dependencies-0.1.1/dev_dependencies.egg-info/PKG-INFO`
...
### Comparing `dev-dependencies-0.0.1/pyproject.toml` & `dev-dependencies-0.1.1/pyproject.toml`
