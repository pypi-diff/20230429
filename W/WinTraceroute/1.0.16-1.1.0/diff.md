# Comparing `tmp/WinTraceroute-1.0.16.tar.gz` & `tmp/WinTraceroute-1.1.0.tar.gz`
...
+gzip compressed data, was "WinTraceroute-1.1.0.tar", last modified: Sat Apr 29 12:40:44 2023, max compression
```

## Comparing `WinTraceroute-1.0.16.tar` & `WinTraceroute-1.1.0.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-29 12:40:44.404203 WinTraceroute-1.1.0/
+-rw-r--r--   0 runner    (1001) docker     (123)    18092 2023-04-29 12:40:08.000000 WinTraceroute-1.1.0/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)    21345 2023-04-29 12:40:44.404203 WinTraceroute-1.1.0/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)     4542 2023-04-29 12:40:08.000000 WinTraceroute-1.1.0/README.md
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-29 12:40:44.404203 WinTraceroute-1.1.0/WinTraceroute.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)    21345 2023-04-29 12:40:44.000000 WinTraceroute-1.1.0/WinTraceroute.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      327 2023-04-29 12:40:44.000000 WinTraceroute-1.1.0/WinTraceroute.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-04-29 12:40:44.000000 WinTraceroute-1.1.0/WinTraceroute.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       59 2023-04-29 12:40:44.000000 WinTraceroute-1.1.0/WinTraceroute.egg-info/entry_points.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       57 2023-04-29 12:40:44.000000 WinTraceroute-1.1.0/WinTraceroute.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       11 2023-04-29 12:40:44.000000 WinTraceroute-1.1.0/WinTraceroute.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)     1374 2023-04-29 12:40:08.000000 WinTraceroute-1.1.0/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-04-29 12:40:44.404203 WinTraceroute-1.1.0/setup.cfg
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-29 12:40:44.404203 WinTraceroute-1.1.0/traceroute/
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-04-29 12:40:08.000000 WinTraceroute-1.1.0/traceroute/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     4090 2023-04-29 12:40:08.000000 WinTraceroute-1.1.0/traceroute/__main__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     7269 2023-04-29 12:40:08.000000 WinTraceroute-1.1.0/traceroute/traceroute.py
```

### Comparing `WinTraceroute-1.0.16/pyproject.toml` & `WinTraceroute-1.1.0/pyproject.toml`
...
### Comparing `WinTraceroute-1.0.16/traceroute/__main__.py` & `WinTraceroute-1.1.0/traceroute/__main__.py`
...
### Comparing `WinTraceroute-1.0.16/traceroute/traceroute.py` & `WinTraceroute-1.1.0/traceroute/traceroute.py`
