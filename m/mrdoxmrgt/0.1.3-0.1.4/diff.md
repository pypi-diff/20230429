# Comparing `tmp/mrdoxmrgt-0.1.3.tar.gz` & `tmp/mrdoxmrgt-0.1.4.tar.gz`
...
## Comparing `mrdoxmrgt-0.1.3.tar` & `mrdoxmrgt-0.1.4.tar`
...
### Comparing `mrdoxmrgt-0.1.3/LICENSE` & `mrdoxmrgt-0.1.4/LICENSE`

 * *Files identical despite different names*

### Comparing `mrdoxmrgt-0.1.3/PKG-INFO` & `mrdoxmrgt-0.1.4/PKG-INFO`
...
### Comparing `mrdoxmrgt-0.1.3/mrdoxmrgt.egg-info/PKG-INFO` & `mrdoxmrgt-0.1.4/mrdoxmrgt.egg-info/PKG-INFO`
...
### Comparing `mrdoxmrgt-0.1.3/setup.py` & `mrdoxmrgt-0.1.4/setup.py`
