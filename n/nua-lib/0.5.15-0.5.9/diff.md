# Comparing `tmp/nua_lib-0.5.15.tar.gz` & `tmp/nua_lib-0.5.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "nua_lib-0.5.15.tar", max compression
+gzip compressed data, was "nua_lib-0.5.9.tar", max compression
```

## Comparing `nua_lib-0.5.15.tar` & `nua_lib-0.5.9.tar`

### file list

```diff
@@ -1,34 +1,16 @@
--rw-r--r--   0        0        0      857 2023-04-29 09:12:48.086709 nua_lib-0.5.15/README.md
--rw-r--r--   0        0        0     1377 2023-04-29 09:15:48.534892 nua_lib-0.5.15/pyproject.toml
--rw-r--r--   0        0        0      218 2023-02-06 17:21:30.499791 nua_lib-0.5.15/src/nua/lib/__init__.py
--rw-r--r--   0        0        0     1281 2023-04-26 08:44:27.767101 nua_lib-0.5.15/src/nua/lib/actions/__init__.py
--rw-r--r--   0        0        0     3944 2023-04-26 08:44:27.767310 nua_lib-0.5.15/src/nua/lib/actions/apt.py
--rw-r--r--   0        0        0       40 2023-04-26 08:44:27.767629 nua_lib-0.5.15/src/nua/lib/actions/constants.py
--rw-r--r--   0        0        0     3042 2023-04-26 08:44:27.767773 nua_lib-0.5.15/src/nua/lib/actions/misc.py
--rw-r--r--   0        0        0     2225 2023-04-26 08:44:27.767911 nua_lib-0.5.15/src/nua/lib/actions/nodejs.py
--rw-r--r--   0        0        0     6158 2023-04-26 08:44:27.768064 nua_lib-0.5.15/src/nua/lib/actions/python.py
--rw-r--r--   0        0        0     1395 2023-04-26 08:44:27.768281 nua_lib-0.5.15/src/nua/lib/actions/ruby.py
--rw-r--r--   0        0        0     7254 2023-04-26 08:44:27.768430 nua_lib-0.5.15/src/nua/lib/actions/util.py
--rw-r--r--   0        0        0     2899 2023-04-29 09:12:48.089784 nua_lib-0.5.15/src/nua/lib/archive_search.py
--rw-r--r--   0        0        0      769 2023-01-11 17:39:15.272394 nua_lib-0.5.15/src/nua/lib/backports.py
--rw-r--r--   0        0        0     1621 2023-04-26 08:44:27.768703 nua_lib-0.5.15/src/nua/lib/console.py
--rw-r--r--   0        0        0      517 2023-04-29 09:12:48.089860 nua_lib-0.5.15/src/nua/lib/constants.py
--rw-r--r--   0        0        0        0 2023-04-29 09:12:48.089913 nua_lib-0.5.15/src/nua/lib/db/__init__.py
--rw-r--r--   0        0        0     1437 2023-04-29 09:12:48.089973 nua_lib-0.5.15/src/nua/lib/db/db_manager.py
--rw-r--r--   0        0        0     6245 2023-04-29 09:12:48.090060 nua_lib-0.5.15/src/nua/lib/db/mariadb_manager.py
--rw-r--r--   0        0        0     8650 2023-04-29 09:12:48.090151 nua_lib-0.5.15/src/nua/lib/db/postgres_manager.py
--rw-r--r--   0        0        0     2203 2023-04-29 09:12:48.090259 nua_lib-0.5.15/src/nua/lib/db/sqlite_manager.py
--rw-r--r--   0        0        0     6232 2023-04-29 09:12:48.090353 nua_lib-0.5.15/src/nua/lib/docker.py
--rw-r--r--   0        0        0      584 2023-04-29 09:12:48.090430 nua_lib-0.5.15/src/nua/lib/elapsed.py
--rw-r--r--   0        0        0     5600 2023-03-06 16:13:43.253043 nua_lib-0.5.15/src/nua/lib/exec.py
--rw-r--r--   0        0        0      828 2023-04-08 16:30:34.876808 nua_lib-0.5.15/src/nua/lib/gen_password.py
--rw-r--r--   0        0        0    13058 2023-04-29 09:12:48.090536 nua_lib-0.5.15/src/nua/lib/nua_config.py
--rw-r--r--   0        0        0      544 2023-04-29 09:12:48.090591 nua_lib-0.5.15/src/nua/lib/nua_tag.py
--rw-r--r--   0        0        0     3361 2023-04-26 08:44:27.769137 nua_lib-0.5.15/src/nua/lib/panic.py
--rw-r--r--   0        0        0     3983 2023-04-26 08:44:27.769312 nua_lib-0.5.15/src/nua/lib/shell.py
--rw-r--r--   0        0        0       60 2023-02-06 17:21:30.499928 nua_lib-0.5.15/src/nua/lib/tool/__init__.py
--rw-r--r--   0        0        0     3572 2023-04-26 08:44:27.769516 nua_lib-0.5.15/src/nua/lib/tool/color_str.py
--rw-r--r--   0        0        0     1420 2023-04-26 08:44:27.769875 nua_lib-0.5.15/src/nua/lib/tool/state.py
--rw-r--r--   0        0        0     2121 2023-04-26 08:44:27.770049 nua_lib-0.5.15/src/nua/lib/unarchiver.py
--rw-r--r--   0        0        0       79 2023-01-03 14:14:59.347734 nua_lib-0.5.15/src/nua/lib/version.py
--rw-r--r--   0        0        0     1453 1970-01-01 00:00:00.000000 nua_lib-0.5.15/PKG-INFO
...
### Comparing `nua_lib-0.5.15/pyproject.toml` & `nua_lib-0.5.9/pyproject.toml`
...
### Comparing `nua_lib-0.5.15/src/nua/lib/backports.py` & `nua_lib-0.5.9/src/nua/lib/backports.py`

 * *Files identical despite different names*

### Comparing `nua_lib-0.5.15/src/nua/lib/console.py` & `nua_lib-0.5.9/src/nua/lib/console.py`
...
### Comparing `nua_lib-0.5.15/src/nua/lib/exec.py` & `nua_lib-0.5.9/src/nua/lib/exec.py`

 * *Files identical despite different names*

### Comparing `nua_lib-0.5.15/src/nua/lib/gen_password.py` & `nua_lib-0.5.9/src/nua/lib/gen_password.py`

 * *Files identical despite different names*

### Comparing `nua_lib-0.5.15/src/nua/lib/shell.py` & `nua_lib-0.5.9/src/nua/lib/shell.py`
...
### Comparing `nua_lib-0.5.15/src/nua/lib/tool/color_str.py` & `nua_lib-0.5.9/src/nua/lib/tool/color_str.py`
...
### Comparing `nua_lib-0.5.15/src/nua/lib/tool/state.py` & `nua_lib-0.5.9/src/nua/lib/tool/state.py`
...
### Comparing `nua_lib-0.5.15/src/nua/lib/unarchiver.py` & `nua_lib-0.5.9/src/nua/lib/unarchiver.py`
...
### Comparing `nua_lib-0.5.15/PKG-INFO` & `nua_lib-0.5.9/PKG-INFO`
