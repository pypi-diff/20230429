# Comparing `tmp/sentient_switchblade-0.2.1.tar.gz` & `tmp/sentient_switchblade-0.2.2.tar.gz`
...
## Comparing `sentient_switchblade-0.2.1.tar` & `sentient_switchblade-0.2.2.tar`
...
### Comparing `sentient_switchblade-0.2.1/LICENSE` & `sentient_switchblade-0.2.2/LICENSE`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.2.1/README.md` & `sentient_switchblade-0.2.2/README.md`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.2.1/pyproject.toml` & `sentient_switchblade-0.2.2/pyproject.toml`
...
### Comparing `sentient_switchblade-0.2.1/src/switchbladecli/cli/__main__.py` & `sentient_switchblade-0.2.2/src/switchbladecli/cli/__main__.py`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.2.1/src/switchbladecli/cli/bundle_cache.py` & `sentient_switchblade-0.2.2/src/switchbladecli/cli/bundle_cache.py`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.2.1/src/switchbladecli/cli/lint.py` & `sentient_switchblade-0.2.2/src/switchbladecli/cli/lint.py`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.2.1/src/switchbladecli/cli/test.py` & `sentient_switchblade-0.2.2/src/switchbladecli/cli/test.py`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.2.1/src/switchbladecli/cli/update.py` & `sentient_switchblade-0.2.2/src/switchbladecli/cli/update.py`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.2.1/src/switchbladecli/modes/python_poetry.py` & `sentient_switchblade-0.2.2/src/switchbladecli/modes/python_poetry.py`
...
### Comparing `sentient_switchblade-0.2.1/src/switchbladecli/utils.py` & `sentient_switchblade-0.2.2/src/switchbladecli/utils.py`

 * *Files identical despite different names*

### Comparing `sentient_switchblade-0.2.1/setup.py` & `sentient_switchblade-0.2.2/setup.py`
...
### Comparing `sentient_switchblade-0.2.1/PKG-INFO` & `sentient_switchblade-0.2.2/PKG-INFO`
