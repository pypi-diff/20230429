# Comparing `tmp/TsProject-1.0.4.tar.gz` & `tmp/TsProject-1.0.5.tar.gz`
...
## Comparing `TsProject-1.0.4.tar` & `TsProject-1.0.5.tar`
...
### Comparing `TsProject-1.0.4/_core.py` & `TsProject-1.0.5/TsProject/post.py`
...
### Comparing `TsProject-1.0.4/setup.py` & `TsProject-1.0.5/setup.py`
...
-    long_description="TsProject Init: File POST to Cloud",
