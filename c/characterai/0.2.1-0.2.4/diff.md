# Comparing `tmp/characterai-0.2.1.tar.gz` & `tmp/characterai-0.2.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist\characterai-0.2.1.tar", last modified: Sat Apr 29 11:50:43 2023, max compression
+gzip compressed data, was "dist\characterai-0.2.4.tar", last modified: Sat Apr 29 10:49:05 2023, max compression
```

## Comparing `characterai-0.2.1.tar` & `characterai-0.2.4.tar`

### file list

```diff
@@ -1,16 +1,16 @@
-drwxrwxrwx   0        0        0        0 2023-04-29 11:50:43.710323 characterai-0.2.1/
--rw-rw-rw-   0        0        0     1082 2023-04-28 16:51:34.000000 characterai-0.2.1/LICENSE
--rw-rw-rw-   0        0        0      455 2023-04-29 11:50:43.709323 characterai-0.2.1/PKG-INFO
--rw-rw-rw-   0        0        0       63 2023-04-28 17:26:52.000000 characterai-0.2.1/README.md
-drwxrwxrwx   0        0        0        0 2023-04-29 11:50:43.628338 characterai-0.2.1/characterai/
--rw-rw-rw-   0        0        0       90 2023-04-29 10:41:38.000000 characterai-0.2.1/characterai/__init__.py
--rw-rw-rw-   0        0        0     9358 2023-04-29 11:50:04.000000 characterai-0.2.1/characterai/characterai.py
--rw-rw-rw-   0        0        0      126 2023-04-28 20:05:16.000000 characterai-0.2.1/characterai/errors.py
-drwxrwxrwx   0        0        0        0 2023-04-29 11:50:43.706323 characterai-0.2.1/characterai.egg-info/
--rw-rw-rw-   0        0        0      455 2023-04-29 11:50:43.000000 characterai-0.2.1/characterai.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      273 2023-04-29 11:50:43.000000 characterai-0.2.1/characterai.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-04-29 11:50:43.000000 characterai-0.2.1/characterai.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       19 2023-04-29 11:50:43.000000 characterai-0.2.1/characterai.egg-info/requires.txt
--rw-rw-rw-   0        0        0       12 2023-04-29 11:50:43.000000 characterai-0.2.1/characterai.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2023-04-29 11:50:43.711325 characterai-0.2.1/setup.cfg
--rw-rw-rw-   0        0        0      615 2023-04-29 11:49:51.000000 characterai-0.2.1/setup.py
...
### Comparing `characterai-0.2.1/LICENSE` & `characterai-0.2.4/LICENSE`

 * *Files identical despite different names*

### Comparing `characterai-0.2.1/characterai/characterai.py` & `characterai-0.2.4/characterai/characterai.py`
...
### Comparing `characterai-0.2.1/setup.py` & `characterai-0.2.4/setup.py`
