# Comparing `tmp/fabric2-3.0.0.tar.gz` & `tmp/fabric2-3.0.1.tar.gz`
...
### Comparing `fabric2-3.0.0/sites/_shared_static/logo.png` & `fabric2-3.0.1/sites/_shared_static/logo.png`
